...
# Open the CodeSuite connection URL in the default browser
echo "Opening the CodeSuite connection URL in the default browser..."
ConnectionURL="https://$AWS_REGION.console.aws.amazon.com/codesuite/settings/$AWS_ACCOUNT_ID/$AWS_REGION/codeconnections/connections/$CODE_CONNECTION_ID"
